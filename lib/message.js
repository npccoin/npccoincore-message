...
const { _ } = npccoincore.deps;
const { PrivateKey, PublicKey, Address } = npccoincore;
const { BufferWriter } = npccoincore.encoding;
const { ECDSA, Signature } = npccoincore.crypto;
const { sha256sha256 } = npccoincore.crypto.Hash;
const JSUtil = npccoincore.util.js;
const $ = npccoincore.util.preconditions;
