...
For more information refer to the [npccoincore-message](https://github.com/bitpay/npccoincore-message) github repo.
...
```bash
npm install npccoincore-message --save
```

For client-side projects:

```bash
bower install npccoincore-message --save
```
